...
<!-- 			<li class="active"><a href="/User">首页</a></li>
			...
			<%
				if(session.getAttribute("employee") == null){
					if(session.getAttribute("user")!= null){
			%>
			<li><a href="<%=request.getContextPath()+"/sale/branchDateChoose"%>">甜品预订</a></li> &nbsp;&nbsp;&nbsp;&nbsp;
			<%
					}
				} else{
			%>
			<s:if test="#session.employee.authority == 0">
				<li><a href="<%=request.getContextPath()+"/employee/employeeList"%>">店员管理</a></li> &nbsp;&nbsp;&nbsp;&nbsp;
			</s:if>
			...
			<s:if test="#session.employee.authority == 1">
				...
				<li><a href="<%=request.getContextPath()+"/employee/Analyse.jsp"%>">月度统计</a></li> &nbsp;&nbsp;&nbsp;&nbsp;
			</s:if>
			...
			%>
			<li><a href="<%=request.getContextPath()+"/branch/branchList"%>">门店信息</a></li> &nbsp;&nbsp;&nbsp;&nbsp;
			<%
			...
			<li><a href="<%=request.getContextPath() + "/employee/Login.jsp" %>">员工登录</a></li> &nbsp;&nbsp;&nbsp;&nbsp;
			<li><a href="<%=request.getContextPath() + "/user/register.jsp" %>">会员注册</a></li> &nbsp;&nbsp;&nbsp;&nbsp;
			<%
				}
			%>
		</ul>
		<form class="navbar-form navbar-right" action="#" role="search">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="<%=request.getContextPath()+"/user/passwordChange.jsp" %>">密码修改</a></li>
					<li><a href="<%=request.getContextPath()+"/sale/saleList" %>">我的订单</a></li>
					<li><a href="<%=request.getContextPath()+"/user/payRecord" %>">充值记录</a></li>
					<li><a href="<%=request.getContextPath()+"/user/pointChange.jsp" %>">积分兑换</a></li>
					<li><a href="<%=request.getContextPath()+"/user/top_up.jsp" %>">充值</a>
					<li class="divider"></li>
			...
			<%} else if(session.getAttribute("employee") != null){%>
				...
				<ul class="dropdown-menu" role="menu">
					<li><a href="<%=request.getContextPath()+"/user/memberInfo.jsp" %>">个人设置</a></li>
					<li><a href="<%=request.getContextPath()+"/employee/password.jsp" %>">密码修改</a></li>
					<li class="divider"></li>
					<li><a href="<%=request.getContextPath()+"/employee/logout"%>">退出登录</a></li>
				</ul>
			</div>
			<%} %>
